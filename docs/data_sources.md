...
| TESS (3) | — no custodian dictionary held | Study custodians at NTNU. The inventory in `configs/cohorts/tess.yaml` is built from the published cohort profile, the study's wave list and its anxiety-course paper |
